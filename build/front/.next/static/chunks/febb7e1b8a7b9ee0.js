...
<body>
  ${D.map(t=>{var r;let n,s=t.isFirst?"COTIZACIÓN":`CONTINUACI\xd3N ${t.pageNumber}/${t.totalPages}`,D=t.isFirst?o(e.title||"Cotización comercial"):`Continuaci\xf3n de ${o(e.title||"Cotización comercial")}`,z=t.isFirst?`
        <div class='grid'>
          <div class='card'>
          ...
          <div class='card'>
            ...
            ${v?l("Descuento global",e.discount,e.currency):""}
            ${y?l("Impuesto",e.tax,e.currency):""}
      ...
      `:"",P=t.isLast?`
        <div class='sections'>
          <div>
            ${$?`<div class='card'><div class='box-title'>Observaciones</div><div class='box-value'>${o(e.observations||"-")}</div></div><div style='height:16px'></div>`:""}
            ${k?`<div class='card'><div class='box-title'>Condiciones comerciales</div><div class='box-value'>${o(e.commercialTerms||"-")}</div></div>`:""}
          </div>
          <div class='totals'>
            <div class='totals-row'><span>Subtotal</span><strong>${o(a(e.subtotal,e.currency))}</strong></div>
            ${v?`<div class='totals-row'><span>Descuento</span><strong>${o(a(e.discount,e.currency))}</strong></div>`:""}
            ${y?`<div class='totals-row'><span>Impuesto</span><strong>${o(a(e.tax,e.currency))}</strong></div>`:""}
      ...
      <div class='page'>
        ...
        ${t.isFirst&&e.documentHeader?.trim()?`<div class='document-header'>${o(e.documentHeader).replace(/&lt;(\/?)(b|strong|u|ul|ol|li|div|p|br)&gt;/gi,"<$1$2>").replace(/&lt;font size=&quot;([235])&quot;&gt;/gi,'<font size="$1">').replace(/&lt;\/font&gt;/gi,"</font>")}</div>`:""}
          ...
          <table>
            <thead>
              <tr>
                ...
                ${j?"<th style='width:16%; text-align:right;'>Desc.</th>":""}
                <th style='text-align:right;width:${j?"18%":"28%"};'>Subtotal</th>
              </tr>
            </thead>
            <tbody>
